...
#### We get the tensorflow url using the environment variable, for two pods K8s launching
tensorflow_url = 'http://' + os.environ.get('tensorflow_url') + '/v1/models/user_embedding_model:predict'
